...
# Environment
###############################################################################
set_load -pin_load 0.0150 [get_ports {clk_out}]
set_load -pin_load 0.0100 [get_ports {fb_out}]
...
set_driving_cell -lib_cell sky130_fd_sc_hs__buf_8 -pin {X} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {fb_in}]
